   ...
   public static void loadImages() {
      try {
         ...
         for (String keyWord : mapKeyWords)
            ht.put(keyWord, ImageIO.read(new File("C:/Users/yigit/Desktop/4711A-bomberman-master/images/map/basic/"+keyWord+".png")));

         for (String color : personColors)
            for (String keyWord : personKeyWords)
               ht.put(color+"/"+keyWord, ImageIO.read(new File("C:/Users/yigit/Desktop/4711A-bomberman-master/images/person/"+color+"/"+keyWord+".png")));
      } catch (IOException e) {
